...
switch body2use
    case 'right'
        ...
        BodyCSVListCA.Right = stnhemiTABle.moveIND;
        BodyVideoIndex.Right = fullfile(BodyVidDir.Right ,"VideoINFO.xlsx");
    case 'left'
        BodyVidDir.Left = [mainFOLDloc , '\LeftBody'];
        % BodyCSVsrch.Left = fullfile(BodyVidDir.Left, '*.csv');
        % BodyCSVList.Left = dir(BodyCSVsrch.Left);
        BodyCSVListCA.Left = stnhemiTABle.moveIND;
        BodyVideoIndex.Left = fullfile(BodyVidDir.Left ,"VideoINFO.xlsx");
end
...
for groupIi = 1:2
    ...
    conditionID.(groups2id{groupIi}) = stnhemiTABle.CONDITION{groupRind};
    videoID.(groups2id{groupIi}) = stnhemiTABle.VIDEO{groupRind};
    ...
    [someDATA] = computeKIN_LFPcor(restIItable,moveIItable,...
        trimFrame_int.(groups2id{groupIi}),...
        streamOfInt.Left.Left.(groups2id{groupIi}),...
...
function  [someDATA] = computeKIN_LFPcor(restIItable,moveIItable,...
