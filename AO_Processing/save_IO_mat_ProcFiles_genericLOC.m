function [] = save_IO_mat_ProcFiles_genericLOC(mat_filelist, rawDataDir, saveDataDir, ACC_IO)

% hardcode directories
RawDataDir = rawDataDir; % directory where raw MATLAB data files are located (case-specific)
ProcDataDir = saveDataDir; % directory where processed MATLAB data should be saved (case-specific)
