...
% L_streamsofInt_OnMed = {L_streamOfInt_s1, L_streamOfInt_s3, L_streamOfInt_s5, L_streamOfInt_s7, L_streamOfInt_s9}; % w/o baseline
L_streamsofInt_OnMed = {L_streamOfInt_js2_bsln, L_streamOfInt_js2_s1_OffStim, L_streamOfInt_js2_s2_OffStim, L_streamOfInt_js2_s1_OnStim, L_streamOfInt_js2_s2_OnStim}; % w/o ramp

% Titles for each plot in L_streamsofInt_OffMed
% plotTitles = {
%     'LSTN baseline (On Med, Off Stim @ 0 mA)', 
%     'LSTN set1 (On Med, Off Stim @ 0 mA)', 
%     'LSTN set2 (On Med, Off Stim @ 0 mA)', 
%     'LSTN ramp (On Med, Stim Ramping)', 
%     'LSTN set1 (On Med, On Stim @ max mA)', 
%     'LSTN set2 (On Med, On Stim @ max mA)'};
...
% R_streamsofInt_OnMed = {R_streamOfInt_s2, R_streamOfInt_s4, R_streamOfInt_s6, R_streamOfInt_s8, R_streamOfInt_s10}; % w/o baseline
R_streamsofInt_OnMed = {R_streamOfInt_js2_bsln, R_streamOfInt_js2_s1_OffStim, R_streamOfInt_js2_s2_OffStim, R_streamOfInt_js2_s1_OnStim, R_streamOfInt_js2_s2_OnStim}; % w/o ramp

% Titles for each plot in L_streamsofInt_OffMed
% plotTitles = {
%     'RSTN baseline (On Med, Off Stim @ 0 mA)', 
%     'RSTN set1 (On Med, Off Stim @ 0 mA)', 
%     'RSTN set2 (On Med, Off Stim @ 0 mA)', 
%     'RSTN ramp (On Med, Stim Ramping)', 
...
first_tab_vid_table = all_tab_vids_table.(tab_vid_names{6});
...
dlc_vidObj = VideoReader('20230912_idea08_session013_rightCam-0000DLC_resnet50_Clin_2023-09-12_LSTN_v3Oct3shuffle1_100000_labeled-converted.mp4');
...
% session001
s1_Tablet_StartFrame = 180;
s1_Tablet_StopFrame = 2340;
...
streamOfInt = L_streamOfInt_js2_s1_OffStim;
...
maxBetaPower_L = zeros(1, length(L_streamsofInt_OnMed));
maxBetaPower_R = zeros(1, length(R_streamsofInt_OnMed));

for i = 1:length(L_streamsofInt_OnMed)
    lfpData = L_streamsofInt_OnMed{i};
    [inst_freq_filtered_L, maxBetaPower_L(i), ts_LFPtmp_L] = analyze_LFPBetaPower(lfpData, fs);
end

for i = 1:length(R_streamsofInt_OnMed)
    lfpData = R_streamsofInt_OnMed{i};
...
conditions = {'baseline_OnOff', 'OnOff_s1', 'OnOff_s2', 'OnOn_s1', 'OnOn_s2'};
T = table(conditions', maxBetaPower_L', maxBetaPower_R', 'VariableNames', {'Condition', 'maxBetaPower_L', 'maxBetaPower_R'});
writetable(T, 'maxBetaPower_per_Condition_OnMed.csv');
