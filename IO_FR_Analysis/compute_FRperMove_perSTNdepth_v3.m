...
for depthName = {'dorsal','central','ventral'}
    ...
    for movT_i = 1:numel(moveType_ids)
        ...
        for row_i = 1:height(move_subtbl)
            ...
            dur_sec  = (t_end - t_start) / AO_spike_fs;
        ...
        keepCols = {'move_trial_ID','MoveType','Depth','TTL_spk_idx_Start','TTL_spk_idx_End','FR_Hz','FR_Duration_s','FR_SpikeCount'};
...
if ~isempty(summary_Data)
    FR_Summary_All = vertcat(summary_Data{:});
else
