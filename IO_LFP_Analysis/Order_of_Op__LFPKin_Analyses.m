...
%% Plot LFP beta band in T-F domain

% continuous wavelet transform
[cwt_power_beta, cwt_freq_beta] = cwt(lfp_data_test_beta, fs_downsamp ,'FrequencyLimits',[1 125],'VoicesPerOctave',14); % try 14, mults of 7
figure;
cwt(lfp_data_test_beta,fs_downsamp,'FrequencyLimits',[1 125],'VoicesPerOctave',14); % try 14, mults of 7
xlabel('Time (s)');
ylabel('Frequency (Hz)');
ylim([5 50])
title('LFP Beta Band in T-F domain during motor trial rep', 'Continuous Wavelet Transform');
