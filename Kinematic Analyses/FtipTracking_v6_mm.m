...
all_amplitudes = [OffOff_data.amplitudes; OffOn_data.amplitudes; OnOff_data.amplitudes; OnOn_data.amplitudes];
all_widths = [OffOff_data.widths; OffOn_data.widths; OnOff_data.widths; OnOn_data.widths];
all_peakDists = [OffOff_data.peakDists; OffOn_data.peakDists; OnOff_data.peakDists; OnOn_data.peakDists];
...
group_labels_amplitudes = [repmat({'OffOff'}, length(OffOff_data.amplitudes), 1);
    repmat({'OffOn'}, length(OffOn_data.amplitudes), 1);
    repmat({'OnOff'}, length(OnOff_data.amplitudes), 1);
    repmat({'OnOn'}, length(OnOn_data.amplitudes), 1)];

group_labels_widths = [repmat({'OffOff'}, length(OffOff_data.widths), 1);
    repmat({'OffOn'}, length(OffOn_data.widths), 1);
    repmat({'OnOff'}, length(OnOff_data.widths), 1);
    repmat({'OnOn'}, length(OnOn_data.widths), 1)];

group_labels_peakDists = [repmat({'OffOff'}, length(OffOff_data.peakDists), 1);
    repmat({'OffOn'}, length(OffOn_data.peakDists), 1);
    repmat({'OnOff'}, length(OnOff_data.peakDists), 1);
    repmat({'OnOn'}, length(OnOn_data.peakDists), 1)];
