...
% '05_18_2023_b_bilateral'; % NER 2025, NANS 2026, INS 2026      % 3 (LSTN) %% check movement indices
% '05_31_2023';                                  % INS 2026      % 4
% '06_08_2023_bilateral';   % NER 2025, NANS 2026, INS 2026      % 5 (LSTN) %% movement indices redone (HG)
% '07_06_2023_bilateral';                        % INS 2026      % 6 (LSTN)
% '07_13_2023_bilateral';                        % INS 2026      % 7 (LSTN, RSTN)
% '07_20_2023';                                  % GRC 2026      % 8 (LSTN)
% '07_26_2023';                                  % GRC 2026      % 8 (RSTN)
% '08_23_2023';                       % NANS 2026, INS 2026      % 9
% '11_30_2023_bilateral';                        % GRC 2026      % 10 (LSTN, RSTN)
% '12_06_2023_bilateral';                        % GRC 2026      % 10 (LSTN, RSTN)


%% Input: Case-specific Kinematic data dir

MoveDataDir = [IO_DataDir, filesep, 'Processed DLC'];
cd(MoveDataDir)

% Specify case ID
MoveDir_CaseID = 'IO_12_06_2023_LSTN'; % Adjust as needed

% 'IO_03_23_2023_LSTN'; % NER 2025, INS 2026, GRC 2026
% 'IO_04_05_2023_RSTN'; % NER 2025, INS 2026, GRC 2026
% 'IO_04_13_2023_LSTN'; %           GRC 2026
% 'IO_05_18_2023_b_LSTN'; % NER 2025, INS 2026         %% check movement indices
% 'IO_05_31_2023_LSTN';
% 'IO_06_08_2023_LSTN'; % NER 2025, INS 2026           %% check movement indices
% 'IO_07_06_2023_LSTN';
% 'IO_07_13_2023_LSTN'; % INS 2026, GRC 2026
% 'IO_07_13_2023_RSTN'; %           GRC 2026
% 'IO_07_20_2023_LSTN'; %           GRC 2026
% 'IO_07_26_2023_RSTN'; %           GRC 2026
% 'IO_08_23_2023_RSTN'; % INS 2026, GRC 2026
...
%% Notes (IO data dir, Ephys)

% '03_09_2023'; % studyID = 1, ptID 1    x % cut

% '03_23_2023'; % studyID = 2, ptID 2    * % INS 2026
% '04_05_2023'; % studyID = 3, ptID 2    * % INS 2026
...
% LSTN: studyID = 8, ptID = 5            * % INS 2026
% RSTN: studyID = 9, ptID = 5

% '05_31_2023'; % studyID = 10, ptID 6   * % INS 2026

% '06_08_2023_bilateral';
% LSTN: studyID = 11, ptID = 7           * % INS 2026
% RSTN: studyID = 12, ptID = 7

% '07_06_2023_bilateral';
% LSTN: studyID = 14, ptID = 8           * % INS 2026

% '07_13_2023_bilateral';
% LSTN: studyID = 15, ptID = 9           * % INS 2026
% RSTN: studyID = 16, ptID = 9

% '08_23_2023';                          * % INS 2026


%% Notes (Processed DLC dir, Kinematics)
...
%% Run align_MUA_perMove_TTL

All_SpikesPerMove_Tbl_MUA = align_MUA_perMove_TTL(All_SpikesPerMove_Tbl, ProcDataDir, ...
    AO_spike_fs, pre_offset_ms, Case_FRKin_Dir);


%% Cases to prioritize for spike sorting quality review first

% cd 'C:\Users\erinr\OneDrive - The University of Colorado Denver\Documents 1\GitHub\NeuroKinematica\SpikeQualityReviewer'; 
% > SpkClusterQualRev_script

% 04_13_2023_LSTN
% 07_06_2023_LSTN
% 08_23_2023
% 11_30_2023 (bilateral)
