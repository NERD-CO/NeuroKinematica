...
pspectrum(cleanLFP_OffOff,250,'FrequencyLimits',[0 50],'FrequencyResolution',3) % 2 or 3
[bPxx,bFxx] = pspectrum(cleanLFP_OffOff,250,'FrequencyLimits',[0 50],'FrequencyResolution',3); %
bPxxP = pow2db(bPxx);
